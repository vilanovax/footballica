...
export function HubSecondarySkeleton({
  ...
  return (
    ...
    >
      <div className="h-[7.5rem] animate-pulse rounded-bubble-xl bg-[hsl(var(--arena-mid)/0.55)] shadow-[0_0_0_1px_hsl(var(--arena-ring)/0.12)]" />
      <div className="grid grid-cols-2 gap-1.5">
        <div className="h-14 animate-pulse rounded-bubble-xl bg-[hsl(var(--arena-mid)/0.45)]" />
        <div className="h-14 animate-pulse rounded-bubble-xl bg-[hsl(var(--arena-mid)/0.45)]" />
      </div>
      <div className="h-20 animate-pulse rounded-bubble-xl bg-[hsl(var(--arena-mid)/0.35)]" />
