...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  },
  {
    ...
    descriptionFa: "در پنالتی قفل‌شده روی یک موضوع، همه را گل کن.",
  ...
  },
  {
    ...
    emoji: "🏅",
    nameEn: "Triple Medal",
    nameFa: "سه‌گانهٔ مدال",
    descriptionEn: "Earn a Penalty medal in 3 different topics.",
    descriptionFa: "در ۳ موضوع مختلف پنالتی مدال بگیر.",
  ...
  },
  {
    ...
    emoji: "🏆",
    nameEn: "Five Medals",
    nameFa: "پنج‌گانهٔ مدال",
    descriptionEn: "Earn a Penalty medal in 5 different topics.",
    descriptionFa: "در ۵ موضوع مختلف پنالتی مدال بگیر.",
  ...
  },
  {
    ...
    emoji: "👑",
    nameEn: "Medal King",
    nameFa: "سلطان مدال‌ها",
    descriptionEn: "Earn a Penalty medal in 10 different topics.",
    descriptionFa: "در ۱۰ موضوع مختلف پنالتی مدال بگیر.",
  ...
  },
  {
    ...
    tier: "gold",
    emoji: "💎",
    nameEn: "Untouchable Medal",
    nameFa: "مدال دست‌نخورده",
    descriptionEn: "Earn a topic medal without any help.",
    descriptionFa: "مدال یک موضوع را بدون هیچ کمک بگیر.",
